...
//	
//	File: IMoviesystem.h
//  Description:	Gives access to movie functions from within the game. 
// 
//	History:
//	- 26/4/2002: Created by Timur Davidenko 
...
//////////////////////////////////////////////////////////////////////
//! Animation parameter stored in animation node.
struct SAnimParam
{
	...
	SAnimParam( const char *_name,AnimParamType _id,IAnimTrack *pTrack=0 ) { strcpy_s(name,_name); id = _id; track = pTrack; }
	SAnimParam( const SAnimParam &anim ) { *this = anim; }
	SAnimParam& operator=( const SAnimParam &anim )
	{
		strcpy_s(name,anim.name);
		id = anim.id;
		track = anim.track;
		return *this;
	}

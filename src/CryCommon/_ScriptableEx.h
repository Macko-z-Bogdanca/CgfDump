...
//
//  File: _ScriptableEx.h
//  Description: Template for generating scriptable objects.
//	Interface to the scripting engine (using Lua).
//
//  History:
//  - 2/8/2001: File created 

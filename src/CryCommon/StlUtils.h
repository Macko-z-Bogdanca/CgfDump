...
namespace stl
{
	...
	template <class Type>
	struct less__stricmp : public std::binary_function<Type,Type,bool> 
	{
		bool operator()( const Type &left,const Type &right ) const
		{
	...
	//////////////////////////////////////////////////////////////////////////
	// Hash map usage:
	// typedef stl::unordered_map<string,int, stl::hash__stricmp<string> > StringToIntHash;
	//////////////////////////////////////////////////////////////////////////
...
#if !defined(LINUX)
	// Support for both Microsoft and SGI kind of unordered_map.
	template <class Key,class Value,class HashFunc>
	class unordered_map : 
#ifdef _STLP_unordered_map // STL Port

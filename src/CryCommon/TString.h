...
//	
//	File: TArray.h
//	Description : STL-compatible string. 
//		This is supposed to be a collection of string class implementations 
//		for different purposes.
//
//	History:
//	- Created by Timur Davidenko and Sergiy Migdalsky

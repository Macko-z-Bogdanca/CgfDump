...
// that audigy cards or drivers are having problems when the default EAX off preset
...
//////////////////////////////////////////////////////////////////////////
// Structures to pass as data-entry to the music system
//////////////////////////////////////////////////////////////////////////
...
typedef std::map<CryBasicString,string,stl::less__stricmp<CryBasicString> > TThemeBridgeMap;
typedef TThemeBridgeMap::iterator							TThemeBridgeMapIt;

typedef std::map<CryBasicString,SMusicMood*,stl::less__stricmp<CryBasicString> > TMoodMap;
...
typedef std::map<CryBasicString,SMusicTheme*,stl::less__stricmp<CryBasicString> >	TThemeMap;
